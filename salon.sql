...
--
-- Name: appointments customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: appointments service_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT service_id_fkey FOREIGN KEY (service_id) REFERENCES public.services(service_id);
